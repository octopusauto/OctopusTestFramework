...
public class ZapProcessUtil {
	...
	private static void startZap() throws Exception {
		...
		new ProcessBuilder(
				"/Users/pushpinderrattan/Desktop/Zap/OWASP ZAP.app/Contents/Java/zap.sh",
				"-daemon", "-port " + ZAP_PORT).start();
	...
	public static void main(String[] args) throws Exception {
		...
		System.out
				.println("Sleep for 10 sec, to  record URL to find vulnerabilities");
		Thread.sleep(10000);
	...
	public static void generateReport() {
		...
		ReportGenerator.stringToHtml(report.entityEncode(alert2.toString()),
				"test.html");
